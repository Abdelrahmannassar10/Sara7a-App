...
const router = Router();
router.delete("/", isAuthenticated, userRouter.deleteUser);
...
router.post("/upload-profile-picture-cloud", isAuthenticated, uploadfileCloud().single("profilePicture"), userRouter.uploadProfilePictureCloud);
